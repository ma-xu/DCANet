...
__all__ = ['sk_mobilenet_v2']

class SKLayer(nn.Module):
    def __init__(self,in_planes, out_planes, kernel_size=3, stride=1, groups=1, reduction = 8):
...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio):
        ...
        layers.extend([
            ...
            SKLayer(hidden_dim, hidden_dim, stride=stride, groups=hidden_dim),
            # pw-linear
...
def sk_mobilenet_v2(pretrained=False, **kwargs):
    """
...
def demo():
    net = sk_mobilenet_v2(num_classes=1000)
