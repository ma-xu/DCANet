...
__all__ = [ 'cbam_mnasnet0_5', 'cbam_mnasnet0_75', 'cbam_mnasnet1_0', 'cbam_mnasnet1_3']
...
class BasicConv(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0 \
        ...
        self.bn = nn.BatchNorm2d(out_planes,momentum=_BN_MOMENTUM , affine=True) if bn else None
...
class _InvertedResidual(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, kernel_size, stride, expansion_factor,
        ...
        self.cbam = CBAM(out_ch,8)

    def forward(self, input):
        if self.apply_residual:
            return self.cbam(self.layers(input)) + input
        else:
            return self.cbam(self.layers(input))
...
def cbam_mnasnet0_5(pretrained=False, progress=True, **kwargs):
...
def cbam_mnasnet0_75(pretrained=False, **kwargs):
...
def cbam_mnasnet1_0(pretrained=False, **kwargs):
...
def cbam_mnasnet1_3(pretrained=False, **kwargs):
...
def demo():
    net = cbam_mnasnet1_0(num_classes=1000)
