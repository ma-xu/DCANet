...
def dca_getheta_resnet18(pretrained=False, **kwargs):
...
def dca_getheta_resnet34(pretrained=False, **kwargs):
...
def dca_getheta_resnet50(pretrained=False, **kwargs):
...
def dca_getheta_resnet101(pretrained=False, **kwargs):
...
def dca_getheta_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = dca_getheta_resnet50(num_classes=1000)
