...
__all__ = ['sk2_resnet18', 'sk2_resnet34', 'sk2_resnet50', 'sk2_resnet101',
           'sk2_resnet152']
...
def sk2_resnet18(pretrained=False, **kwargs):
...
def sk2_resnet34(pretrained=False, **kwargs):
...
def sk2_resnet50(pretrained=False, **kwargs):
...
def sk2_resnet101(pretrained=False, **kwargs):
...
def sk2_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = sk2_resnet50(num_classes=1000)
